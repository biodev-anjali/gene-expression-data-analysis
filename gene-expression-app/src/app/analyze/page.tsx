...
export default function Analyze() {
   ...
   * This function automatically triggers analysis when a file is selected.
   * No manual "Analyze" button is needed - analysis starts immediately.
   */
   ...
   * Automatically triggers analysis when a file is selected
   */
  function handleFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (file) {
      ...
      if (!file.name.endsWith('.csv')) {
        setMsg("Error: Only CSV files are accepted. Please select a CSV file.")
        return
      }
      analyzeFile(file)
    }
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div className="scifi-card" style={{
          ...
          <div style={{
            ...
            {/* File Input - Auto-triggers analysis */}
            ...
            {loading && (
              <div style={{
                ...
                <p style={{ color: "#00f0ff", fontSize: "14px" }}>
